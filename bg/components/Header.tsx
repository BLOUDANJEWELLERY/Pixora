...
export default function SidebarHeader(): ReactElement {
      ...
      icon: (
        ...
        >
          <path
            ...
            strokeLinejoin="round"
            strokeWidth={2}
            d="M3 7V5a2 2 0 012-2h2M21 7V5a2 2 0 00-2-2h-2M3 17v2a2 2 0 002 2h2m10 0h2a2 2 0 002-2v-2"
          />
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
  ...
  return (
    <>
      ...
      {/* Mobile Sidebar */}
      <div
        className={`fixed top-0 left-0 h-screen w-80 bg-white/10 backdrop-blur-2xl border-r border-blue-200/30 shadow-2xl transform transition-transform duration-300 ease-in-out z-50 md:hidden ${
